...
namespace PapaSreet.AdminUI.Controllers
{
    public class UserController : BaseController
    {
        ...
        //    var dto = _userServiceFacade.GetById(model.Id,Status.Active);
        //    if (dto == null)
        //    {
        //        response.Failure(UI.UserNotFound);
        //        return Json(response);
        //    }
        //    if (HashHelper.Verify(dto.Password, user.Password))
        //        response = _userServiceFacade.ResetPassword(dto.Email, model.NewPassword, Status.Active);
